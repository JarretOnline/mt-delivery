...
RegisterNetEvent('mt-delivery:client:PedirEntrega', function()
    ...
    QBCore.Functions.Progressbar('falar_empregada', 'CHECKING IN FOR DELIVERY', 5000, false, true, {
    ...
    QBCore.Functions.Notify('DELIVERY RECEIVED! COOKING TACOS', 'primary', 7500)
    
    Wait(Config.DeliveryWait)

    QBCore.Functions.Notify('ORDER UP! FOLLOW YOUR GPS. KNOCK ON THE DOOR!', 'primary', 7500)
...
RegisterNetEvent('mt-delivery:client:BaterPorta', function()
    ...
    QBCore.Functions.Progressbar('falar_empregada', 'DELIVERING FOOD', 5000, false, true, {
        disableMovement = true,
        disableCarMovement = true,
        disableMouse = false,
        disableCombat = true,
    }, {}, {}, {}, function()
    QBCore.Functions.Notify('DELIVERY COMPLETE. HEAD BACK FOR PAYMENT!', 'primary', 7500)
